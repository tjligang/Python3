...
## 变量和对象
 ...
 - 对象(object)：Python中的对象是一个内存空间，其中保存数据，根据内存区域是否可以被修改，分为可变对象（list，dict等）和不可变对象（number，string，tuple等）。
...
两个变量之间赋值，`var2`中的对象地址复制给`var1`，结果两个变量指向同一个对象。对于可变对象，这样的赋值会导致通过变量`var1`修改对象，变量`var2`的值也随之改变。

 - `var1 = value` `var2 = value`

两个变量分别被赋予相同的值，对于
不可变对象：因为对象不会被改变，`var1` `var2`保存同一对象的地址，即指向同一对象。这样能够节省内存（取决于实现方式）。
...
> [Doc : Common Sequence Operations][17]

## 可变序列操作

 可变序列操作会改变序列中的值，适用于可读写的序列，比如list。list在此基础上还增加了排序等操作。

> [Doc : Mutable Sequence Types][18]
> [Doc : Lists][19]
...
> [廖雪峰python教程-字符串和编码][20]
> [unicode编码简介][21]
> [学点编码知识又不会死：Unicode的流言终结者和编码大揭秘][22]
> [从字节理解Unicode（UTF8/UTF16)][23]
> [utf-8与utf-8(无BOM)的区别][24]
> [理性看待utf-8 BOM][25]
...
> [廖雪峰python教程-使用dict和set][29]
  ...
  [16]: http://www.liaoxuefeng.com/wiki/0014316089557264a6b348958f449949df42a6d3a2e542c000/001431658624177ea4f8fcb06bc4d0e8aab2fd7aa65dd95000
  [17]: https://docs.python.org/3/library/stdtypes.html#common-sequence-operations
  [18]: https://docs.python.org/3/library/stdtypes.html#mutable-sequence-types
  [19]: https://docs.python.org/3/library/stdtypes.html#lists
  [20]: http://www.liaoxuefeng.com/wiki/0014316089557264a6b348958f449949df42a6d3a2e542c000/001431664106267f12e9bef7ee14cf6a8776a479bdec9b9000
  [21]: http://www.cnblogs.com/hongfei/p/3648794.html
  [22]: http://www.freebuf.com/articles/web/25623.html
  [23]: http://www.cnblogs.com/zizifn/p/4716712.html
  [24]: http://afericazebra.blog.163.com/blog/static/30050408201211199298711/
  [25]: https://www.zhihu.com/question/20167122
  [26]: https://docs.python.org/3/library/stdtypes.html#string-methods
  [27]: https://docs.python.org/3/library/stdtypes.html#printf-style-string-formatting
